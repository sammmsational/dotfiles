return {
  ...
  ['Finder'] = ':finder:',
  ['访达'] = ':finder:',
  ['Firefox'] = ':firefox_developer_edition:', -- changed from :firefox:
  ...
  ['Iris'] = ':iris:',
  ['iTerm'] = ':iterm:',
  ['iTerm2'] = ':terminal:', -- changed from :iterm:
  ...
  ['Parsec'] = ':parsec:',
  ['Passwords'] = ':passwords:',
  ['Preview'] = ':preview:', -- changed from :pdf:
  ['预览'] = ':pdf:',
  ['Skim'] = ':pdf_old:', -- changed from :pdf:
  ['zathura'] = ':pdf_old:', -- changed from :pdf:
  ['Aperçu'] = ':pdf:',
  ['プレビュー'] = ':pdf:',
